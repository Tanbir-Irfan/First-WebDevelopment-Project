...
<body>
    ...
    <?php }
        ...
        {?>
            <script type="text/javascript">
                $(document).ready(function(){
                    $("#status").html('<p style="color:green;margin-left:-70px;">Account Updated Successfully!!!</p>');
                });
            </script>
    <?php }
    ...
    <?php }
    ?>
    <form action="create_account_data.php?uni_id=<?php echo $_REQUEST["uni_id"]?>&update" method="POST" enctype="multipart/form-data">
        <fieldset>
            ...
            <input type="text" name="password" placeholder="********" value="<?php
            ...
            &nbsp;Go Back</a></button>
            <input type="submit" name="submit" style="margin-left:88px;background:#6b6b6b;color:white;padding:5px 15px;margin-top: 10px;width:70px;font-weight:bold;" value="Update">
            </fieldset>
        </form>

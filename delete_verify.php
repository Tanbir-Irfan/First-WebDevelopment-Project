...
<body> 
    ...
    <p style="background: #575b6e;margin-left: 390px;font-size: 17px;margin-bottom: 30px;padding: 8px;margin-top: 0px;border-radius: 5px;color: #ebefef;text-align: center; width:320px;">/* Please enter your email and password */</p>
    ...
    <?php
        ...
        <script type="text/javascript">
            $(document).ready(function(){
                $("#para").html('<p style="color:Green;margin-left: -135px;">/* Account Deleted Successfully and Go Back for log in */</p>');
            });
        </script>
        <?php }?>
    <div class="div1">
        <form action="logindb.php?delete" method="POST">
        ...
        <label><b>Username&nbsp;:</b></label>
            ...
            &nbsp;Go Back</a></button>
            <input type="submit" name="submit" style="background: #6b6b6b;color: white;padding: 5px 15px;width: 70px;font-weight: bold;float: right;margin-bottom: 15px;margin-right:480px;" value="Delete" id="delete">
        </form>
    </div>
    <!-- <script>
        $(document).ready(function(){
